...
type Request_Init struct {
	Init *InitializeRequest `protobuf:"bytes,2,opt,name=init,oneof"`
}
...
type Request_State struct {
	State *StateRequest `protobuf:"bytes,4,opt,name=state,oneof"`
}
...
type Response_Keepalive struct {
	Keepalive *KeepAliveResponse `protobuf:"bytes,2,opt,name=keepalive,oneof"`
}
type Response_State struct {
	State *StateResponse `protobuf:"bytes,3,opt,name=state,oneof"`
}
type Response_Restore struct {
	Restore *RestoreResponse `protobuf:"bytes,4,opt,name=restore,oneof"`
}
...
func (m *InfoResponse) MarshalTo(data []byte) (int, error) {
	...
	if m.Wants != 0 {
		data[i] = 0x8
		i++
		i = encodeVarintUdf(data, i, uint64(m.Wants))
	}
	if m.Provides != 0 {
		data[i] = 0x10
		i++
		i = encodeVarintUdf(data, i, uint64(m.Provides))
	}
	if len(m.Options) > 0 {
		for k, _ := range m.Options {
			...
			msgSize := v.Size()
			mapSize := 1 + len(k) + sovUdf(uint64(len(k))) + 1 + msgSize + sovUdf(uint64(msgSize))
			...
			data[i] = 0x12
			i++
			i = encodeVarintUdf(data, i, uint64(v.Size()))
...
func (m *OptionInfo) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *OptionInfo) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.ValueTypes) > 0 {
		for _, num := range m.ValueTypes {
			data[i] = 0x8
			i++
			i = encodeVarintUdf(data, i, uint64(num))
		}
	}
	return i, nil
}
...
func (m *OptionValue) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *OptionValue) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Type != 0 {
		data[i] = 0x8
		i++
		i = encodeVarintUdf(data, i, uint64(m.Type))
	}
	if m.Value != nil {
...
func (m *OptionValue_BoolValue) MarshalTo(data []byte) (int, error) {
	i := 0
	data[i] = 0x10
	i++
	if m.BoolValue {
...
func (m *OptionValue_IntValue) MarshalTo(data []byte) (int, error) {
	i := 0
	data[i] = 0x18
	i++
...
func (m *OptionValue_DoubleValue) MarshalTo(data []byte) (int, error) {
	i := 0
	data[i] = 0x21
	i++
...
func (m *OptionValue_StringValue) MarshalTo(data []byte) (int, error) {
	i := 0
	data[i] = 0x2a
	i++
	i = encodeVarintUdf(data, i, uint64(len(m.StringValue)))
	i += copy(data[i:], m.StringValue)
	return i, nil
}
func (m *OptionValue_DurationValue) MarshalTo(data []byte) (int, error) {
	i := 0
	data[i] = 0x30
	i++
	i = encodeVarintUdf(data, i, uint64(m.DurationValue))
	return i, nil
}
...
func (m *Request) MarshalTo(data []byte) (int, error) {
	...
	_ = l
	if m.Message != nil {
		nn3, err := m.Message.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn3
...
func (m *Request_Info) MarshalTo(data []byte) (int, error) {
	...
	if m.Info != nil {
		data[i] = 0xa
		i++
		i = encodeVarintUdf(data, i, uint64(m.Info.Size()))
...
func (m *Request_Init) MarshalTo(data []byte) (int, error) {
	...
	if m.Init != nil {
		...
		n5, err := m.Init.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *Request_Begin) MarshalTo(data []byte) (int, error) {
	...
	if m.Begin != nil {
		...
		n9, err := m.Begin.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func (m *Response) MarshalTo(data []byte) (int, error) {
	...
	_ = l
	if m.Message != nil {
		nn12, err := m.Message.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn12
...
func (m *Response_Keepalive) MarshalTo(data []byte) (int, error) {
	...
	if m.Keepalive != nil {
		...
		i++
		i = encodeVarintUdf(data, i, uint64(m.Keepalive.Size()))
		n14, err := m.Keepalive.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n14
...
func (m *Response_Begin) MarshalTo(data []byte) (int, error) {
	...
	if m.Begin != nil {
		...
		i++
		i = encodeVarintUdf(data, i, uint64(m.Begin.Size()))
		n18, err := m.Begin.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n18
...
func (m *Response_End) MarshalTo(data []byte) (int, error) {
	...
	if m.End != nil {
		...
		i++
		i = encodeVarintUdf(data, i, uint64(m.End.Size()))
		n20, err := m.End.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *InfoResponse) Size() (n int) {
	...
	_ = l
	if m.Wants != 0 {
		n += 1 + sovUdf(uint64(m.Wants))
	}
	if m.Provides != 0 {
		n += 1 + sovUdf(uint64(m.Provides))
	}
	if len(m.Options) > 0 {
		for k, v := range m.Options {
			...
			mapEntrySize := 1 + len(k) + sovUdf(uint64(len(k))) + 1 + l + sovUdf(uint64(l))
...
func (m *OptionValue) Size() (n int) {
	var l int
	_ = l
	if m.Type != 0 {
		n += 1 + sovUdf(uint64(m.Type))
	}
	if m.Value != nil {
		n += m.Value.Size()
	}
...
func (m *OptionValue_BoolValue) Size() (n int) {
	var l int
	_ = l
	n += 2
	return n
}
func (m *OptionValue_IntValue) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovUdf(uint64(m.IntValue))
	return n
}
func (m *OptionValue_DoubleValue) Size() (n int) {
	var l int
	_ = l
	n += 9
	return n
}
func (m *OptionValue_StringValue) Size() (n int) {
	var l int
	_ = l
	l = len(m.StringValue)
	n += 1 + l + sovUdf(uint64(l))
...
func (m *OptionValue_DurationValue) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovUdf(uint64(m.DurationValue))
	return n
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[iNdEx]
				iNdEx++
				m.Provides |= (EdgeType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			...
			iNdEx = postmsgIndex
			if m.Options == nil {
				m.Options = make(map[string]*OptionInfo)
			}
...
func (m *OptionInfo) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OptionInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OptionInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			m.ValueTypes = append(m.ValueTypes, v)
		default:
			iNdEx = preIndex
			skippy, err := skipUdf(data[iNdEx:])
			if err != nil {
...
func (m *Option) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Values = append(m.Values, &OptionValue{})
...
func (m *OptionValue) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OptionValue: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OptionValue: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			...
			b := bool(v != 0)
			m.Value = &OptionValue_BoolValue{b}
		case 3:
			if wireType != 0 {
			...
			m.Value = &OptionValue_IntValue{v}
		case 4:
			if wireType != 1 {
			...
			m.Value = &OptionValue_DoubleValue{float64(math.Float64frombits(v))}
		case 5:
			if wireType != 2 {
			...
			m.Value = &OptionValue_StringValue{string(data[iNdEx:postIndex])}
			iNdEx = postIndex
		case 6:
			if wireType != 0 {
			...
			m.Value = &OptionValue_DurationValue{v}
		default:
			iNdEx = preIndex
			skippy, err := skipUdf(data[iNdEx:])
			if err != nil {
